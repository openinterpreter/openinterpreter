...
impl BottomPane {
    ...
    /// Update the status indicator header (defaults to "Interpreting") and details below it.
    ///
...
mod tests {
    ...
    fn composer_shown_after_denied_while_task_running() {
        ...
        // Render and ensure the top row includes the Interpreting header and a composer line below.
